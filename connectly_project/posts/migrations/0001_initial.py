    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('EDITOR', 'Editor'), ('VIEWER', 'Viewer'), ('USER', 'Regular User')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy', models.CharField(choices=[('PUBLIC', 'Public - Visible to everyone'), ('FRIENDS', 'Friends - Visible to connections only'), ('PRIVATE', 'Private - Visible only to me')], default='PUBLIC', max_length=10)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': [('view_private_post', 'Can view private posts')],
            },
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_visibility', models.CharField(choices=[('PUBLIC', 'Public - Visible to everyone'), ('FRIENDS', 'Friends - Visible to connections only'), ('PRIVATE', 'Private - Visible only to me')], default='PUBLIC', max_length=10)),
                ('post_default', models.CharField(choices=[('PUBLIC', 'Public - Visible to everyone'), ('FRIENDS', 'Friends - Visible to connections only'), ('PRIVATE', 'Private - Visible only to me')], default='PUBLIC', max_length=10)),
